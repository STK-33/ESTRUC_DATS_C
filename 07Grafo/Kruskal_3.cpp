 ...
 */ 
 ...
 //Estructura arista
 struct Edge{ 
     int nodos;     //Vértice origen 
     int vertices;    //Vértice destino 
     int peso;       //Peso entre el vértic
     Edge(){} 
 ...
 void Kruskal(){ 
     ...
     for( int i = 0 ; i < E ; ++i ){     //Recorremos las aristas ya ordenadas por peso 
         nodos = arista[ i ].nodos;    //Vértice origen de la arista actual 
         destino = arista[ i ].vertices;  //Vértice destino de la arista actual 
